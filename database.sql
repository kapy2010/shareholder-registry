...
create table company (id serial primary key, name varchar(50) not null);
create table investor (id serial primary key, name varchar(50) not null);

insert into company(name) values('Company A AS');
insert into company(name) values('Company B AS');
